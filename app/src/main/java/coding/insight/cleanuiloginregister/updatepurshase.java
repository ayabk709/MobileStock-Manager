...
public class updatepurshase extends AppCompatActivity {
...
purshasy p ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatepurshase);

        autoCompleteprod = findViewById(R.id.purch1);
        edit2 = findViewById(R.id.purch5);
        edit = findViewById(R.id.purch4);
        edit3 = findViewById(R.id.purch3);
        autoCompletecust = findViewById(R.id.purch2);
        ...
        autoCompleteitems = findViewById(R.id.purch6);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(updatepurshase.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void save( ) {
        ...
        FirebaseDatabase.getInstance().getReference().child("purshasyyy").child(getRef(position).getKey()).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(updatepurshase.this, "Data uploaded successfully", Toast.LENGTH_SHORT).show();

            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(updatepurshase.this, "Error", Toast.LENGTH_SHORT).show();
